...
import '../../student/Assignment/AssignmentStyles.css';
...
const LecturerCourseDetails = () => {
    ...
    const handleFileUpload = async (e, field) => {
        ...
        try {
            ...
            if (presignedRes.data && presignedRes.data.data) {
                ...
                setLessonForm(prev => ({ ...prev, [field]: fileUrl }));
            }
        } catch (err) {
    ...
    // Lecturers cannot delete courses
    ...
    if (!course && !loading) {
        return (
            <div className="course-container">
                ...
                <button className="btn-card-action" style={{ width: '200px' }} onClick={() => navigate('/lecturer/courses')}>
                    Back to list
                </button>
            </div>
        );
    ...
    return (
        <div className="course-container">
            ...
            <div className="details-breadcrumb">
                <Link to="/lecturer/dashboard" className="breadcrumb-link">Home</Link>
                <span>/</span>
                <Link to="/lecturer/courses" className="breadcrumb-link">Courses</Link>
                <span>/</span>
            ...
            <div className="course-header" style={{ marginBottom: '1.25rem' }}>
                ...
                {/* Lecturers cannot edit or delete courses here */}
            </div>
                        ...
                        <form onSubmit={handleSaveLesson}>
                            ...
                            <div className="modal-form-group">
                                ...
                                <div style={{ display: 'flex', gap: '10px' }}>
                                    ...
                                    <button 
                                        ...
                                        disabled={uploadingMedia}
                                        style={{ flexShrink: 0, padding: '0 1rem', background: '#e0e7ff', color: '#4338ca' }}
                                    >
                                        📁 Upload File
                                    </button>
                                </div>
                            ...
                            <div className="modal-actions" style={{ marginTop: '1.5rem' }}>
                                ...
                                <button
                                    ...
                                    disabled={savingLesson || uploadingMedia}
                                >
                                    {savingLesson || uploadingMedia ? 'Processing...' : (editingLessonId ? 'Update Lesson' : 'Add Lesson')}
                                </button>
                            </div>
                        </form>
                    </div>
                                        ...
                                        onChange={async (e) => {
                                            ...
                                            try {
                                                ...
                                                if (presignedRes.data && presignedRes.data.data) {
                                                    ...
                                                    setCourseForm({ ...courseForm, thumbnailUrl: fileUrl });
                                                }
                                            } catch (err) {
